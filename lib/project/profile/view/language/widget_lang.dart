  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        ...
        child: Row(
          children: [
            Padding(padding: const EdgeInsets.only(left: 16.0, right: 16.0), child: RadioIndicator(isSelected: isSelected)),
            Text(title, style: const TextStyle(color: Color(0xFF414141), fontSize: 16, fontWeight: FontWeight.w400)),
          ],
        ),
      ),
    );
