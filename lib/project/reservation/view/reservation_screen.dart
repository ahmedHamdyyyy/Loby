...
class _ReservationScreenvendorState extends State<ReservationScreenvendor> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [_buildHeader(context), _buildTabButtons(), _buildReservationList()],
      ),
    );
  }
  ...
  Widget _buildReservationList() {
    return Expanded(
      child: ListView(
        ...
        children: isCurrentReservations ? _buildCurrentReservations() : _buildLastReservations(),
      ),
    );
  }

  List<Widget> _buildCurrentReservations() {
    return [_buildCurrentReservationCard(), _buildCurrentReservationCard()];
  }
      ...
      child: Column(
        children: [
          ...
          _buildActivityCardCurrentReservation(
            ...
            date: '14/10/2024',
            onViewDetails: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const CurretReservationDetailsScreenvendor()));
            },
          ),
        ],
      ),
  ...
  List<Widget> _buildLastReservations() {
    return [
      Column(children: [_buildLastReservationHotelCard(), const SizedBox(height: 16), _buildLastReservationActivityCard()]),
    ];
  }
    ...
    return RichText(
      text: TextSpan(
        ...
        children: [
          TextSpan(
            text: label,
            style: GoogleFonts.poppins(fontWeight: FontWeight.w400, fontSize: 14, color: AppColors.secondTextColor),
          ),
          TextSpan(
            text: date,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.only(top: 16, right: 16), child: _buildViewDetailsButton(onViewDetails)),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.only(right: 16), child: _buildViewDetailsButton(onViewDetails)),
          ],
        ),
      ),
    );
  ...
  Widget _buildViewDetailsButton(VoidCallback onPress) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text('View Reservations Details', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w400)),
      ),
    );
  }
